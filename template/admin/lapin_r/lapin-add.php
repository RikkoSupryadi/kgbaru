...
<section class="content">
	<?php if(isset($_POST['lapin-add'])) { ?>
	<div class="alert alert-success">
		<h4>Berhasil</h4>
		Anda telah berhasil melakukan penambahan laporan baru. 
		<a href="?module=lapin_r/lapin-add"><b>Tambah Lagi</b></a> / 
	...
	<div class="box">
		<form action="" method="post">
			...
			<div class="box-footer">
				<button class="btn btn-success" type="submit" name="lapin-add">Tambah Laporan</button>
